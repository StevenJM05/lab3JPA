 ...
 * @author steve_y
 */
@WebServlet(name = "GenPopulares", urlPatterns = {"/GenPopulares"})
public class GenPopulares extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet GenPopulares</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet GenPopulares at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // Redirigir a la JSP
        request.getRequestDispatcher("admin/GPopulares.jsp").forward(request, response);
    }
